...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ndc_session_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('session', models.ForeignKey(orm[u'ndc.session'], null=False)),
            ('tag', models.ForeignKey(orm[u'ndc.tag'], null=False))
        ))
        db.create_unique(u'ndc_session_tags', ['session_id', 'tag_id'])


    def backwards(self, orm):
        # Removing M2M table for field tags on 'Session'
        db.delete_table('ndc_session_tags')
